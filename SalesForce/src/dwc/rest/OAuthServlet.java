...
@WebServlet(name = "oauth", urlPatterns = { "/oauth/*", "/oauth" }, initParams = {
        ...
        @WebInitParam(name = "clientId", value = "3MVG9y6x0357HlefYVUyUi.CZfFChMS0V.5dR6s1k.41jxV2Q_9zNbDiocBlNkomD2T1ZwXvZis9tpJZhGXNz"),
        // clientSecret is 'Consumer Secret' in the Remote Access UI
        @WebInitParam(name = "clientSecret", value = "1105872555814406693"),
        // This must be identical to 'Callback URL' in the Remote Access UI
        @WebInitParam(name = "redirectUri", value = "https://localhost:8443/salesforce/oauth/_callback"),
